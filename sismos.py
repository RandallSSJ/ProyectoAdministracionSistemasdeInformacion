...
CREATE TABLE sismos(
   ...
   FOREIGN KEY(id_categoria)
    ...
    CHECK(magnitud BETWEEN 0 AND 10),
...
CREATE INDEX idx_sismos_lugar_fecha
ON sismos(id_lugar, fecha DESC);

CREATE INDEX idx_sismos_categoria_magnitud
ON sismos(id_categoria, magnitud DESC);
